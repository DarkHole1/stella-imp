...
let rec showMemoryAddress (AbsStella.MemoryAddress i) : showable = s2s "MemoryAddress " >> showString i
...
and showDecl (e : AbsStella.decl) : showable = match e with
  ...
  |    AbsStella.DeclExceptionType type' -> s2s "DeclExceptionType" >> c2s ' ' >> c2s '(' >> showTypeT type' >> c2s ')'
  |    AbsStella.DeclExceptionVariant (stellaident, type') -> s2s "DeclExceptionVariant" >> c2s ' ' >> c2s '(' >> showStellaIdent stellaident  >> s2s ", " >>  showTypeT type' >> c2s ')'
...
and showTypeT (e : AbsStella.typeT) : showable = match e with
  ...
  |    AbsStella.TypeRef type' -> s2s "TypeRef" >> c2s ' ' >> c2s '(' >> showTypeT type' >> c2s ')'
...
and showPattern (e : AbsStella.pattern) : showable = match e with
  ...
  |    AbsStella.PatternInl pattern -> s2s "PatternInl" >> c2s ' ' >> c2s '(' >> showPattern pattern >> c2s ')'
  |    AbsStella.PatternInr pattern -> s2s "PatternInr" >> c2s ' ' >> c2s '(' >> showPattern pattern >> c2s ')'
...
and showExpr (e : AbsStella.expr) : showable = match e with
       AbsStella.Sequence (expr0, expr) -> s2s "Sequence" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.Assign (expr0, expr) -> s2s "Assign" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.If (expr0, expr1, expr) -> s2s "If" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr1  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.Let (patternbindings, expr) -> s2s "Let" >> c2s ' ' >> c2s '(' >> showList showPatternBinding patternbindings  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.LetRec (patternbindings, expr) -> s2s "LetRec" >> c2s ' ' >> c2s '(' >> showList showPatternBinding patternbindings  >> s2s ", " >>  showExpr expr >> c2s ')'
  ...
  |    AbsStella.TypeCast (expr, type') -> s2s "TypeCast" >> c2s ' ' >> c2s '(' >> showExpr expr  >> s2s ", " >>  showTypeT type' >> c2s ')'
  ...
  |    AbsStella.Subtract (expr0, expr) -> s2s "Subtract" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr >> c2s ')'
  ...
  |    AbsStella.Divide (expr0, expr) -> s2s "Divide" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.LogicAnd (expr0, expr) -> s2s "LogicAnd" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.Ref expr -> s2s "Ref" >> c2s ' ' >> c2s '(' >> showExpr expr >> c2s ')'
  |    AbsStella.Deref expr -> s2s "Deref" >> c2s ' ' >> c2s '(' >> showExpr expr >> c2s ')'
  ...
  |    AbsStella.Throw expr -> s2s "Throw" >> c2s ' ' >> c2s '(' >> showExpr expr >> c2s ')'
  |    AbsStella.TryCatch (expr0, pattern, expr) -> s2s "TryCatch" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showPattern pattern  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.TryWith (expr0, expr) -> s2s "TryWith" >> c2s ' ' >> c2s '(' >> showExpr expr0  >> s2s ", " >>  showExpr expr >> c2s ')'
  |    AbsStella.Inl expr -> s2s "Inl" >> c2s ' ' >> c2s '(' >> showExpr expr >> c2s ')'
  |    AbsStella.Inr expr -> s2s "Inr" >> c2s ' ' >> c2s '(' >> showExpr expr >> c2s ')'
  ...
  |    AbsStella.ConstMemory memoryaddress -> s2s "ConstMemory" >> c2s ' ' >> c2s '(' >> showMemoryAddress memoryaddress >> c2s ')'
  |    AbsStella.Var stellaident -> s2s "Var" >> c2s ' ' >> c2s '(' >> showStellaIdent stellaident >> c2s ')'


and showPatternBinding (e : AbsStella.patternBinding) : showable = match e with
       AbsStella.APatternBinding (pattern, expr) -> s2s "APatternBinding" >> c2s ' ' >> c2s '(' >> showPattern pattern  >> s2s ", " >>  showExpr expr >> c2s ')'
