...
let rec prtStellaIdentListBNFC i es : doc = match (i, es) with
    (_,[]) -> (concatD [])
...
let rec prtExtensionNameListBNFC i es : doc = match (i, es) with
    (_,[]) -> (concatD [])
...
and prtDecl (i:int) (e : AbsStella.decl) : doc = match e with
  ...
  |    AbsStella.DeclExceptionType type_ -> prPrec i 0 (concatD [render "exception" ; render "type" ; render "=" ; prtTypeT 0 type_])
  |    AbsStella.DeclExceptionVariant (stellaident, type_) -> prPrec i 0 (concatD [render "exception" ; render "variant" ; prtStellaIdent 0 stellaident ; render ":" ; prtTypeT 0 type_])
...
and prtThrowType (i:int) (e : AbsStella.throwType) : doc = match e with
  ...
  |    AbsStella.SomeThrowType types -> prPrec i 0 (concatD [render "throws" ; prtTypeTListBNFC 9 types])
...
and prtTypeT (i:int) (e : AbsStella.typeT) : doc = match e with
  ...
  |    AbsStella.TypeRecord recordfieldtypes -> prPrec i 2 (concatD [render "{" ; prtRecordFieldTypeListBNFC 0 recordfieldtypes ; render "}"])
  |    AbsStella.TypeVariant variantfieldtypes -> prPrec i 2 (concatD [render "<|" ; prtVariantFieldTypeListBNFC 0 variantfieldtypes ; render "|>"])
  ...
  |    AbsStella.TypeRef type_ -> prPrec i 3 (concatD [render "&" ; prtTypeT 2 type_])
...
and prtPattern (i:int) (e : AbsStella.pattern) : doc = match e with
  ...
  |    AbsStella.PatternInl pattern -> prPrec i 0 (concatD [render "inl" ; render "(" ; prtPattern 0 pattern ; render ")"])
  |    AbsStella.PatternInr pattern -> prPrec i 0 (concatD [render "inr" ; render "(" ; prtPattern 0 pattern ; render ")"])
  |    AbsStella.PatternTuple patterns -> prPrec i 0 (concatD [render "{" ; prtPatternListBNFC 0 patterns ; render "}"])
  |    AbsStella.PatternRecord labelledpatterns -> prPrec i 0 (concatD [render "{" ; prtLabelledPatternListBNFC 0 labelledpatterns ; render "}"])
  |    AbsStella.PatternList patterns -> prPrec i 0 (concatD [render "[" ; prtPatternListBNFC 0 patterns ; render "]"])
  |    AbsStella.PatternCons (pattern1, pattern2) -> prPrec i 0 (concatD [render "(" ; prtPattern 0 pattern1 ; render "," ; prtPattern 0 pattern2 ; render ")"])
...
and prtExpr (i:int) (e : AbsStella.expr) : doc = match e with
       AbsStella.Sequence (expr1, expr2) -> prPrec i 0 (concatD [prtExpr 1 expr1 ; render ";" ; prtExpr 0 expr2])
  |    AbsStella.Assign (expr1, expr2) -> prPrec i 1 (concatD [prtExpr 2 expr1 ; render ":=" ; prtExpr 1 expr2])
  |    AbsStella.If (expr1, expr2, expr3) -> prPrec i 1 (concatD [render "if" ; prtExpr 1 expr1 ; render "then" ; prtExpr 1 expr2 ; render "else" ; prtExpr 1 expr3])
  |    AbsStella.Let (patternbindings, expr) -> prPrec i 0 (concatD [render "let" ; prtPatternBindingListBNFC 0 patternbindings ; render "in" ; prtExpr 0 expr])
  |    AbsStella.LetRec (patternbindings, expr) -> prPrec i 0 (concatD [render "letrec" ; prtPatternBindingListBNFC 0 patternbindings ; render "in" ; prtExpr 0 expr])
  |    AbsStella.LessThan (expr1, expr2) -> prPrec i 2 (concatD [prtExpr 3 expr1 ; render "<" ; prtExpr 3 expr2])
  |    AbsStella.LessThanOrEqual (expr1, expr2) -> prPrec i 2 (concatD [prtExpr 3 expr1 ; render "<=" ; prtExpr 3 expr2])
  |    AbsStella.GreaterThan (expr1, expr2) -> prPrec i 2 (concatD [prtExpr 3 expr1 ; render ">" ; prtExpr 3 expr2])
  |    AbsStella.GreaterThanOrEqual (expr1, expr2) -> prPrec i 2 (concatD [prtExpr 3 expr1 ; render ">=" ; prtExpr 3 expr2])
  |    AbsStella.Equal (expr1, expr2) -> prPrec i 2 (concatD [prtExpr 3 expr1 ; render "==" ; prtExpr 3 expr2])
  |    AbsStella.NotEqual (expr1, expr2) -> prPrec i 2 (concatD [prtExpr 3 expr1 ; render "!=" ; prtExpr 3 expr2])
  |    AbsStella.TypeAsc (expr, type_) -> prPrec i 3 (concatD [prtExpr 3 expr ; render "as" ; prtTypeT 2 type_])
  |    AbsStella.TypeCast (expr, type_) -> prPrec i 3 (concatD [prtExpr 3 expr ; render "cast" ; render "as" ; prtTypeT 2 type_])
  |    AbsStella.Abstraction (paramdecls, expr) -> prPrec i 3 (concatD [render "fn" ; render "(" ; prtParamDeclListBNFC 0 paramdecls ; render ")" ; render "{" ; render "return" ; prtExpr 0 expr ; render "}"])
  |    AbsStella.Variant (stellaident, exprdata) -> prPrec i 3 (concatD [render "<|" ; prtStellaIdent 0 stellaident ; prtExprData 0 exprdata ; render "|>"])
  |    AbsStella.Match (expr, matchcases) -> prPrec i 3 (concatD [render "match" ; prtExpr 2 expr ; render "{" ; prtMatchCaseListBNFC 0 matchcases ; render "}"])
  |    AbsStella.List exprs -> prPrec i 3 (concatD [render "[" ; prtExprListBNFC 0 exprs ; render "]"])
  |    AbsStella.Add (expr1, expr2) -> prPrec i 3 (concatD [prtExpr 3 expr1 ; render "+" ; prtExpr 4 expr2])
  |    AbsStella.Subtract (expr1, expr2) -> prPrec i 3 (concatD [prtExpr 3 expr1 ; render "-" ; prtExpr 4 expr2])
  |    AbsStella.LogicOr (expr1, expr2) -> prPrec i 3 (concatD [prtExpr 3 expr1 ; render "or" ; prtExpr 4 expr2])
  |    AbsStella.Multiply (expr1, expr2) -> prPrec i 4 (concatD [prtExpr 4 expr1 ; render "*" ; prtExpr 5 expr2])
  |    AbsStella.Divide (expr1, expr2) -> prPrec i 4 (concatD [prtExpr 4 expr1 ; render "/" ; prtExpr 5 expr2])
  |    AbsStella.LogicAnd (expr1, expr2) -> prPrec i 4 (concatD [prtExpr 4 expr1 ; render "and" ; prtExpr 5 expr2])
  |    AbsStella.Ref expr -> prPrec i 5 (concatD [render "new" ; render "(" ; prtExpr 5 expr ; render ")"])
  |    AbsStella.Deref expr -> prPrec i 5 (concatD [render "*" ; prtExpr 5 expr])
  |    AbsStella.Application (expr, exprs) -> prPrec i 6 (concatD [prtExpr 6 expr ; render "(" ; prtExprListBNFC 0 exprs ; render ")"])
  ...
  |    AbsStella.Tuple exprs -> prPrec i 6 (concatD [render "{" ; prtExprListBNFC 0 exprs ; render "}"])
  |    AbsStella.Record bindings -> prPrec i 6 (concatD [render "{" ; prtBindingListBNFC 0 bindings ; render "}"])
  |    AbsStella.ConsList (expr1, expr2) -> prPrec i 6 (concatD [render "cons" ; render "(" ; prtExpr 0 expr1 ; render "," ; prtExpr 0 expr2 ; render ")"])
  |    AbsStella.Head expr -> prPrec i 6 (concatD [render "List::head" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.IsEmpty expr -> prPrec i 6 (concatD [render "List::isempty" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.Tail expr -> prPrec i 6 (concatD [render "List::tail" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.Panic  -> prPrec i 6 (concatD [render "panic!"])
  |    AbsStella.Throw expr -> prPrec i 6 (concatD [render "throw" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.TryCatch (expr1, pattern, expr2) -> prPrec i 6 (concatD [render "try" ; render "{" ; prtExpr 0 expr1 ; render "}" ; render "catch" ; render "{" ; prtPattern 0 pattern ; render "=>" ; prtExpr 0 expr2 ; render "}"])
  |    AbsStella.TryWith (expr1, expr2) -> prPrec i 6 (concatD [render "try" ; render "{" ; prtExpr 0 expr1 ; render "}" ; render "with" ; render "{" ; prtExpr 0 expr2 ; render "}"])
  |    AbsStella.Inl expr -> prPrec i 6 (concatD [render "inl" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.Inr expr -> prPrec i 6 (concatD [render "inr" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.Succ expr -> prPrec i 6 (concatD [render "succ" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.LogicNot expr -> prPrec i 6 (concatD [render "not" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.Pred expr -> prPrec i 6 (concatD [render "Nat::pred" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.IsZero expr -> prPrec i 6 (concatD [render "Nat::iszero" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.Fix expr -> prPrec i 6 (concatD [render "fix" ; render "(" ; prtExpr 0 expr ; render ")"])
  |    AbsStella.NatRec (expr1, expr2, expr3) -> prPrec i 6 (concatD [render "Nat::rec" ; render "(" ; prtExpr 0 expr1 ; render "," ; prtExpr 0 expr2 ; render "," ; prtExpr 0 expr3 ; render ")"])
  |    AbsStella.Fold (type_, expr) -> prPrec i 6 (concatD [render "fold" ; render "[" ; prtTypeT 0 type_ ; render "]" ; prtExpr 7 expr])
  |    AbsStella.Unfold (type_, expr) -> prPrec i 6 (concatD [render "unfold" ; render "[" ; prtTypeT 0 type_ ; render "]" ; prtExpr 7 expr])
  ...
  |    AbsStella.ConstMemory memoryaddress -> prPrec i 7 (concatD [prtMemoryAddress 0 memoryaddress])
  |    AbsStella.Var stellaident -> prPrec i 7 (concatD [prtStellaIdent 0 stellaident])
...
and prtPatternBinding (i:int) (e : AbsStella.patternBinding) : doc = match e with
       AbsStella.APatternBinding (pattern, expr) -> prPrec i 0 (concatD [prtPattern 0 pattern ; render "=" ; prtExpr 0 expr])

and prtPatternBindingListBNFC i es : doc = match (i, es) with
    (_,[]) -> (concatD [])
  | (_,[x]) -> (concatD [prtPatternBinding 0 x])
  | (_,x::xs) -> (concatD [prtPatternBinding 0 x ; render "," ; prtPatternBindingListBNFC 0 xs])
